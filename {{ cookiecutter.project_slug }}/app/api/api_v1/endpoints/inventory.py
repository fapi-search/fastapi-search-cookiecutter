...
from app.schemas import (Inventory, InventoryUpsert, InventoryWithWidgets,
...
async def update_inventory(*, inventory_in: InventoryUpsert):
...
async def get_inventory_for_widget(
    *, widget_uuid=Path(title="uuid of widget")
